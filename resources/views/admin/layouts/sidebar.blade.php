<!-- Sidebar -->
<div id="sidebar"
    class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 overflow-y-auto flex flex-col justify-between">
    ...
    <div>
        ...
        <nav>
            ...
            <a href="{{ route('admin.sparepart.index') }}"
                ...
                {{ request()->routeIs('admin.sparepart.index') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                <i
            ...
            <a href="{{ route('admin.kategori-sparepart.index') }}"
                class="flex items-center px-6 py-3 transition-colors
                {{ request()->routeIs('admin.kategori-sparepart.index') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                <i
            ...
            <a href="{{ route('admin.customer.index') }}"
                class="flex items-center px-6 py-3 transition-colors
                {{ request()->routeIs('admin.customer.index') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                <i
                    class="fas fa-users mr-3 {{ request()->routeIs('admin.customer.*') ? 'text-primary-700' : 'text-gray-600' }}"></i>
                <span>Customer</span>
            </a>

            <!-- Transaksi & Servis Motor -->
            <div class="px-6 py-2">
            ...
            <a href="{{ route('admin.transaksi.index') }}"
                ...
                {{ request()->routeIs('admin.transaksi.index') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}"
            ...
            <a href="{{ route('admin.servis.index') }}"
                class="flex items-center px-6 py-3 transition-colors relative
                {{ request()->routeIs('admin.servis.index') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}"
    ...
    <!-- Bawah Sidebar: Profile & Logout -->
    <div class="px-6 py-4 border-t border-gray-200">
        <a href="{{ route('admin.auth.profile') }}"
            class="btn btn-primary text-white flex justify-center items-center px-4 py-2 text-gray-700 rounded-md mb-2">
